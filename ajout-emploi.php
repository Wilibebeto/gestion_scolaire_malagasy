...
<body class="bg-gray">
 <div id="wrapper">            
            ...
            <form method="POST" class="form" id="emploisForm">
                <h3>Ajout d'un emplois du temps</h3><br>
               <input type="text" class="form-control" name="matiere" id="matiere" placeholder="Votre matiere"><br>
               <input type="date" class="form-control" name="date" id="date"><br>
               <input type="text" class="form-control" name="heures" id="heures"  placeholder="Votre heures"><br>
               <input type="submit" name="temps" id="temps" value="Ajouter" class="btn btn-primary">
            </form>
            </main>
        </div>
